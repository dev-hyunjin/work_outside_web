...
//     엑셀
    $('.excel').on('click', () => {
        location.href = "/statistics/excel?workStartTime=" + paramWorkStartTime + "&workEndTime=" + paramWorkEndTime + "&teamNumber=" + paramTeamNumber + "&workplaceNumber=" + paramWorkplaceNumber + "&memberNumber=" + paramMemberNumber;
    });
});